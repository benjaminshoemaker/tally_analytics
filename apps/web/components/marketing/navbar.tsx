      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 lg:px-40">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a
              className="hidden h-9 items-center justify-center rounded-lg border border-[#e8e0d9] bg-transparent px-4 text-sm font-medium text-[#1b140d] transition-all hover:bg-[#f3ede7] active:scale-[0.98] sm:flex"
