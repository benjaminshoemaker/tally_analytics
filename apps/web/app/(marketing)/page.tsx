...
export default function LandingPage() {
  return (
    <main className="flex-grow">
      ...
      <section className="border-y border-stone-100 bg-white/50 py-10">
        <div className="mx-auto max-w-[1200px] px-6 text-center">
          <p className="mb-8 text-sm font-medium text-text-muted">Trusted by developers building on the modern web</p>
      ...
      <section className="px-6 py-24 text-center md:px-10 lg:px-40">
        <div className="mx-auto max-w-2xl">
          <h2 className="mb-6 text-4xl font-semibold text-text-main">Ready to respect your users?</h2>
          <p className="mb-10 text-lg text-text-muted">
            Start tracking your Next.js app traffic today. Free for open source projects.
          </p>
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <a
              className="flex h-12 items-center justify-center gap-2 rounded bg-primary px-8 text-base font-bold text-white shadow-warm transition-all hover:scale-[0.98] hover:bg-primary-hover"
              href={INSTALL_URL}
              rel="noreferrer"
              target="_blank"
            >
            ...
            <a
              className="flex h-12 items-center justify-center gap-2 rounded bg-transparent px-8 text-base font-medium text-text-muted transition-colors hover:text-text-main"
