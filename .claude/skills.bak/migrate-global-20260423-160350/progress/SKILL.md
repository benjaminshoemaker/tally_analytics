...
See [references/multiple-plans-example.md](references/multiple-plans-example.md) for a full example showing overall summary + per-plan breakdowns for main project and multiple features.
