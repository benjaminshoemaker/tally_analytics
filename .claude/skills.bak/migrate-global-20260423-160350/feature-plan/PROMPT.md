...
See [references/example-execution-plan.md](references/example-execution-plan.md) for a condensed example showing overview, integration points, phase dependency graph, pre-phase setup, and a fully specified task with acceptance criteria.
